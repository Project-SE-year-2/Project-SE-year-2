...
EDITOR_SECTION_TITLE_SIZE    = 14   # "EDIT EXAM PERIOD" small caps label
EDITOR_SECTION_TITLE_COLOR   = th.TEXT_TERTIARY
EDITOR_SECTION_HINT_SIZE     = 14
EDITOR_SECTION_HINT_COLOR    = th.TEXT_TERTIARY

EDITOR_PERIOD_TITLE_SIZE     = 18   # large "FALL — Aleph"
EDITOR_PERIOD_TITLE_COLOR    = th.TEXT_PRIMARY
EDITOR_PERIOD_SUBTITLE_SIZE  = 12   # "FALL 2026 — Moed A"
